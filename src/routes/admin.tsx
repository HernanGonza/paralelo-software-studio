    ...
    <div className="flex min-h-screen items-center justify-center bg-hero px-4">
      <div className="w-full max-w-md rounded-3xl border border-border bg-card p-8 shadow-elegant">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {mode === "signin" ? "Ingresá a tu cuenta." : "Crear cuenta de admin."}
        </p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-hero px-4">
      <div className="max-w-md rounded-3xl border border-border bg-card p-8 text-center shadow-elegant">
        ...
        <p className="mt-4 rounded-xl border border-border bg-muted/40 p-4 text-left text-xs text-muted-foreground">
          Para activar permisos, andá al panel de Lovable Cloud → Tabla{" "}
          <code className="rounded bg-background px-1 py-0.5">user_roles</code> y
          agregá una fila con tu <code className="rounded bg-background px-1 py-0.5">user_id</code>{" "}
          y rol <code className="rounded bg-background px-1 py-0.5">admin</code>.
        </p>
        <button
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {projects.length} cargado{projects.length === 1 ? "" : "s"}
            </p>
          </div>
          <button
            onClick={() => {
            ...
            className="rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-soft transition-smooth hover:bg-primary/90"
          >
            + Nuevo proyecto
          </button>
        </div>
